...
python -m py_compile app.py api\index.py appsail_main.py build_snapshot.py functions\salestrends\app_api.py functions\salestrends\index.py scripts\package_appsail.py scripts\build_appsail_image.py scripts\verify_deployments.py

if (Get-Command py -ErrorAction SilentlyContinue) {
  try {
    py -3.9 -m py_compile app.py api\index.py appsail_main.py build_snapshot.py functions\salestrends\app_api.py functions\salestrends\index.py
